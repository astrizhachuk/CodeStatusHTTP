...
Функция КодыОтветаHTTP() Экспорт
	...
	Возврат КодОтветаHTTPСервер.КодыОтветаHTTP();

КонецФункции

Функция ИдентификаторыКодовОтветаHTTP() Экспорт
	
	Возврат КодОтветаHTTPСервер.ИдентификаторыКодовОтветаHTTP();
	
КонецФункции

Функция ОписанияКодовОтветаHTTP() Экспорт
	
	Возврат КодОтветаHTTPСервер.ОписанияКодовОтветаHTTP();
